...
const CylinderheadServices = () => {
    ...
    const dictionary = [
        ...
        [ "تعویض گایت" , "/image/guyt.jpg" , "CylinderheadGitChange" , "به علت دود کردن زیاد خودرو و یا در مواردی خارج شدن سرسیلندر از آب بندی سرسیلندر خودرو نیاز به تعویض گایت سوپاپ دارد." , "flip-left"],
        [ "تعویض سیت" , "/image/seet.png" , "CylinderheadSithChange" , "در مواردی سوختن سرسیلندر ، مشخصاً سیت سرسیلندر ، نیاز به تعویض سیت های آلیاژی و اورسایز دارد که آن را جایگزین میکنیم" , "flip-right" ],
        [ "برقو" , "/image/Borghoo.jpeg" , "CylinderheadBorghooo" , "پس از تعویض گایت سرسیلندر و سوپاپ های اورسایز داخل گایت را برقو کاری کرده که خلاصی سوپاپ و گایت استاندارد شود" , "flip-up"],
        [ "شیم بندی" , "/image/shimbandii.png" , "CylinderheadShimClosing" , "فاصله ی بین ساقه ی سوپاپ و میل سوپاپ قطعه ای قرار میگیرد که نام این قطعه شیم میباشد و با نازک و کلفت کردن شیم سرسیلندر ما شیم بندی میشود" , "flip-down"]
    ]
